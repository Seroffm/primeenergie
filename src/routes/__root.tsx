...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PRIME ENERGIE | Persönliche Tarifberatung für Strom und Gas" },
      {
        name: "description",
        content:
          "PRIME ENERGIE prüft Tarife für Strom und Gas persönlich, verständlich und unverbindlich.",
      },
      {
        property: "og:title",
        content: "PRIME ENERGIE | Persönliche Tarifberatung für Strom und Gas",
      },
      {
        property: "og:description",
        content:
          "Tarife verstehen, Möglichkeiten prüfen und den Wechsel auf Wunsch begleiten lassen.",
      },
